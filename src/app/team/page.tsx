...
const teamMembers = [
  { name: "Fatima Zahra", role: "Marketing Lead", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuB53GJZ5QTXdUjeFqmexeGQNjXGgf3-0yCZcRryTYzOEwcOiRGdHDuESPd2xIVUJQ3d_fLjlUqsPLBMfdD0vTXjYH5lA-x8cr_-t-5n51erSh4aPvL8AqMNH27D7CKlAlPWDNilgtI2-7vJKGU60QPtd5rs1pHyCsOh9EyUs-q_Zj1odWAUFHsB1-U_Ng8oVkDb6ljet7JicrkLpqI9iGI0a2mDC9w3JkygbD6VWpvQDNEdrWGQEFX8npDHIak2GTCetbRI0PJFTdMi", color: "var(--aws-magenta)" },
  { name: "Hamza Khalil", role: "Logistics Lead", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuACcEH3-I0XRf19UjreI_MubzGBfiaBWXyZsIqSJqB_F4__LF0hj3x5Hh76aWu0qLHX-XYc6Hbd183-BOkkx7-JxKX7rT7GufG-4ze4oLWNjKVhUbUqDJvi413zDHFZY4xNuuayZ9DIZtzi72vNhgZoopKXexwQOkQHMGla3j60yug36_0pg0dTCFcS0Dc3GXUiknUe57faSb_1h1W0rlsdZAmlMlaPH6lGhWiNNX2_1jbv633TAcqL2MA-IZTIQ1U-3ygF4z8KRcfD", color: "var(--aws-amber)" },
  { name: "Noor Fatima", role: "Content Creator", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuA8A97YU_nZCBYy93shGgBPywojLqIZlKnauXCj7aSmlGBZLSiH8-86evJbRrHobKq25yTLbmwJd6ZPBmFQLYCkbpNZ0bQxAZF1ToEjkQZ1zR0QnFp6CV4drufu7N-hmfm7fV5sCt8LCN3nvy4YJsGigTM66aCQA9P4vuAltUGMuwYG6XqVdCDSW_REtCnXYTuBXlky-d46eTK5NuT7FhzAZZG2pv3Ay03QGv411S6xqvfLyQLJFL4pZNiIOdmyWAAJg1gBvGP6rRht", color: "var(--aws-purple)" },
  { name: "Bilal Nasir", role: "Event Manager", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBYC6Z9GdvmeadxkAuhbaQwUVNZ_f6VlJK1JHZrXe-RUrnqUORlbWBTOBPxdQF10lfXhxKSRDtVKdZMkOA3A5xgGNITnZpGdmVCi3zzEQCP3evONriQpRm-1fYfr2-K-WFSQmS6ST2m08DgkXZAp4kxhb92_1THuVhCSLsH2is_UIZRTfSSz90yWMLJWHEyjU2lnhAZWZAC3WnbhKW2u99eJnaK64PC66RKO1_azGfgIZ_u37kc1m5S5ZcB3krMskwI6to0piXVF0R4", color: "var(--aws-blue)" },
];
  ...
  return (
    <div className="pt-32 pb-20">
      <div className="page-shell">
        ...
        >
          <PulsingRing color="#FF9900" rings={3} size={180}>
            <Image src={leader.image} alt={leader.name} width={180} height={180} className="h-full w-full object-cover rounded-full" />
          </PulsingRing>
          <div>
        ...
        <section className="mt-14">
          ...
          <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ once: true }} className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {/* Execution Team — FlipCards */}
        <section className="mt-14">
          <AnimatedSection><h2 className="font-headline text-2xl md:text-3xl font-bold text-white tracking-tight">Execution Team</h2></AnimatedSection>
          <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ once: true }} className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
